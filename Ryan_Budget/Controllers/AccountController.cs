...
namespace Ryan_Budget.Controllers
{
    ...
    public class AccountController : UserNames
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase image)
        {
            if (ModelState.IsValid)
            {
                var pPic = "/assets/img/Money_head.jpg";
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, DisplayName = model.FirstName + ' ' + model.LastName, ProfilePic = pPic };
